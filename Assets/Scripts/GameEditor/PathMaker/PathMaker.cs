...
namespace RL.GameEditor
{
    public partial class PathMaker : MonoBehaviour
    {
        ...
        [Header("Windows")]
        public Hierarchy HierarchyWindow;
        ...
        public static bool IsPreviewEnabled
        {
            ...
            set
            {
                Instance.m_IsPreviewEnabled = value;

                Instance.PreviewLine.SetActive(value);
                Instance.PreviewPoint.SetActive(value);
            }
        }
        ...
        public static Modes Mode
        {
            ...
            set
            {
                ...
                IsPreviewEnabled = value == Modes.BuildsPath;
        ...
        public void Awake()
        {
            ...
            {
                if (Mode == Modes.BuildsPath) IsPreviewEnabled = true;
        ...
        public void Update()
        {
            ...
            if (Input.GetKey(KeyCode.Delete) && SelectedPoint != null) SelectedPath.RemovePoint(SelectedPoint);
        ...
        public void Load(params Paths.Path[] paths)
        {
            CardEditorPath createPath(int num)
            {
                ...
                path.Hierarchy = HierarchyWindow; // Ставим контроллер иерархии
